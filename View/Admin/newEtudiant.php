    ...
    <section id=new_etu>
		...
		<div id=form>
			<form method="POST" action="">
				<p><label>Civilite</label> :<label>Mr</label>  <input type="checkbox" name="civilite[]" value=M /><label>Mme</label>  <input type="checkbox" name="civilite[]" value=F /></p>
				...
				<p><label for="prenom_etu">Prenom</label> : <input type="text" id="prenom_etu" name="prenom_etu" /></p>
  				...
  				<p><label for="DOB_etu">Date de naissance</label> : <input type="text" id="DOB_etu" name="DOB_etu" /></p>
