        ...
        <?php foreach ($allEntreprises as $ent): ?>
            <div class="listeEntreprises">
                ...
                <div> <!-- Doit être en display flex -->
                    <div><a href="editerEntreprise?id=<?= $ent['id_client'] ?>" title="Editer"><i class="fas fa-pencil-alt"></i></a> <a href="ficheEntreprise?id=<?= $ent['id_client'] ?>" title="Visualiser"><i class="far fa-eye"></i></a></div>
