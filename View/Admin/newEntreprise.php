    ...
    <section id=new_ent>
		...
		<div id=form>
			<form method="POST" action="">
				...
				<p><label for="CP_ent">Code Postal</label> : <input type="number" name="CP_ent" id="CP_ent"/></p>
				<p><label for="telephone_ent">Téléphone</label> : <input type="number" name="telephone_ent" id="telephone_ent" /></p>
